...
import CoverImage from "../../../../pages/UserProfile/cover-image.jpeg";
import { Avatar, Button, Input,cn, Textarea, Switch, ScrollShadow} from "@nextui-org/react";
...
export default function EditProfile(props) {
    ...
    const InputTypes = [
        ...
        {
            type: "Textarea",
            placeholder: "Unraveling the mysteries of life, from cells to ecosystems. Join the journey! 🌱🔬 Science and discovery.",
    ...
    return (
        <EditProfileWrapper>
            ...
            <div className="profile-cover-edit-profile">
                ...
                <Button startContent={<CameraIcon size={20}/>} color="primary" size="sm" className="Change-cover-button-edit-profile"> Edit Cover</Button>
            </div>
