...
export default function CoinsButton(props) {
    return (
        <div className="flex items-center justify-center  coins-button">
            <div className="price bg-white rounded-md flex items-center">
                <img className="v-bucks-removebg w-[20px] h-[20px] object-cover mr-1" alt="V bucks removebg" src={CoinsIcon}/>
