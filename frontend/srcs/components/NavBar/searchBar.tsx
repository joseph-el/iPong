...
const Searchbar = () => {
    ...
    const words = ['apple', 'banana', 'orange', 'grapes', 'mango', 'pineapple', 'kiwi', 'strawberry', 'blueberry', 'watermelon', 'papaya', 'guava', 'lychee', 'dragonfruit', 'pomegranate', 'cherry', 'pear', 'plum', 'apricot', 'peach', 'nectarine', 'fig', 'date', 'kiwi', 'tangerine', 'clementine', 'lemon', 'lime', 'grapefruit', 'pomelo', 'mandarin', 'persimmon', 'passionfruit', 'raspberry', 'blackberry', 'blackcurrant', 'blueberry', 'cranberry', 'gooseberry',
            ];
