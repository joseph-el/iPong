    ...
    <div className="SignAuth-page">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/Login/sign-in" element={<SignIn />} /> {/* DONE */}
          <Route
          ...
          {/* DONE */}
          <Route
            path="/Login/what-should-we-call-you"
            element={<SetUserNameAndPicture />}
          />{" "}
          {/* DONE */}
          <Route
            path="/Login/find-your-account"
            element={
          ...
          {/* DONE */}
          <Route
            path="/Login/WelcomeNewUser"
            element={<WelcomeNewUser button_text="Back to sign-in" />}
          />{" "}
          {/* DONE */}
          <Route
            path="/Login/we-send-you-code"
            element={
              <WeSentCodeAndPassword
          ...
          {/* DONE */}
          <Route
            path="/Login/We-sent-you-a-code-to-reset-password"
            element={
              <WeSentCodeAndPassword
                title={"We sent you a code"}
